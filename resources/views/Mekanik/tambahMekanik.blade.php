                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            />
                                            <div class="invalid-feedback">Nama Mekanik</div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label">NIK Mekanik</label>
                                            <input type="text" class="form-control" name="nik"
                                                placeholder="Masukkan NIK Mekanik" required
                                            />
                                            <div class="invalid-feedback">Isi NIK Mekanik</div>
                                        </div>
                                        <div class="col-md-6">
