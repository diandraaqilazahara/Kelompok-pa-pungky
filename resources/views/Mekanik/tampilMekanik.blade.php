                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-end">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Data Mekanik</li>
                        </ol>
                    </div>
                </div>
                <!--end::Row-->
                    ...
                    <div class="col-md-12">
                        <div class="card mb-4">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h3 class="card-title mt-1">Data Mekanik</h3>
                                <a href="{{ route('Mekanik.create') }}" class="btn btn-success btn-sm ms-auto">Add</a>
                            </div>
